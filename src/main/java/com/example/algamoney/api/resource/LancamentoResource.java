...
public class LancamentoResource {
	...
	public String uploadAnexo(@RequestParam MultipartFile anexo) throws IOException {
		FileOutputStream out = new FileOutputStream("D:\\dev\\anexos\\anexo--" + anexo.getOriginalFilename());
	...
	public List<LancamentoEstatisticaCategoria> porCategoria() {
		return this.lancamentoRepository.porCategoria(LocalDate.of(2019, Month.MARCH, 1));
	}
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex) {
		...
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDsenvolvedor));
